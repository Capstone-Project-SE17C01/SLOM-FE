...
import { AnswerRequestDTO, AnswerResponseDTO, GetQuestionRequest, PostAnswerRequestDTO, PostQuestionRequestDTO, QuestionResponseDTO } from "../types/IQa";
    ...
    getQuestion: build.mutation<APIResponse<QuestionResponseDTO[]>, GetQuestionRequest>(
      {
        query: (request: GetQuestionRequest) => ({
          url: `/api/QA/GetQuestion?pageNumber=${request.pageNumber}&userId=${request.userId}`,
          method: "GET",
          flashError: false,
        }),
      }
