...
export default function LearnPage() {
  ...
  return (
    <div className="p-8 bg-white dark:bg-gray-900 min-h-screen rounded-b-xl">
      {/* Tabs + Search */}
      <div className="flex lg:flex-row items-center justify-between mb-8 max-md:flex-col max-md:gap-4 max-md:items-start">
        ...
        <div className="flex max-md:flex-col items-center gap-6">
          <SearchInput
            ...
            minWidth="260px"
            withButton
            buttonText={t_learn("studiedSituations")}
      ...
      {ongoingLesson && (
        <div className="mb-8">
          ...
          <div className="bg-gradient-to-r from-primary/5 to-primary/10 dark:from-gray-800 dark:to-gray-900 rounded-xl shadow-sm border border-primary/20 dark:border-gray-700 p-6 max-w-md">
