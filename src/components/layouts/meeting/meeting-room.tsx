          ...
          {room.duration && (
            <div className="flex items-center justify-center mt-1">
              ...
              >
                {room.duration < 60
                  ? `${room.duration}m`
                  : `${Math.floor(room.duration / 60)}h${
                      room.duration % 60 ? ` ${room.duration % 60}m` : ""
                    }`}
              </span>
            </div>
          )}
  ...
  return (
    <div className="space-y-3 p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
      ...
      >
        ...
        <div className="flex-1">
          <div className="font-medium text-base">{t_meetingPage("join")}</div>
          <div
            className={cn(
              "text-xs",
              isDarkMode ? "text-gray-400" : "text-gray-500"
