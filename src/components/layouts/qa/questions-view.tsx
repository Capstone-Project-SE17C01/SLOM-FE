...
import { QuestionResponseDTO, QuestionViewProps } from "../../../types/IQa";
import { useGetQuestionMutation } from "../../../api/QaApi";
import { useEffect, useState } from "react";

export default function QuestionView({ setIsResponseQuestion, setIsSpecifiedPage, setDetailQuestion, isLoadFull, setIsLoadFull, allQuestion, setAllQuestion, savedScrollPosition, setSavedScrollPosition }: Readonly<QuestionViewProps>) {
