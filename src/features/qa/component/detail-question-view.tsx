...
export default function DetailQuestionView({ setIsResponseQuestion, setIsSpecifiedPage, setResponseQuestionId, question }: Readonly<DetailQuestionViewProps>) {
            ...
            <div className="border-b py-4 px-4 w-full">
                ...
                (<div className="flex w-full">
                    ...
                    <div className="w-[93%]">
                        ...
                        <button onClick={() => { setIsResponseQuestion(true); setResponseQuestionId(question.content)}} className="mt-1 flex hover:bg-gray-200 px-3 py-1 rounded-full">
