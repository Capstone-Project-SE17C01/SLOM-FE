...
import { NewAnswerProps, PostAnswerRequestDTO } from "../types";
...
import { usePostAnswerMutation } from "../api";

export default function NewAnswer({ userInfo, setIsResponseQuestion, question }: Readonly<NewAnswerProps>) {
